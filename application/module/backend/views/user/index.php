...
foreach ($this->Items as $key => $value) {
	...
	$arrInfo      = [
		['name' => 'Username',  'value' => Helper::highLightCol($value['username'], $filter_search, $this->arrParam['key'], ['info', 'all'])],
		['name' => 'Fullname',  'value' => Helper::highLightCol($value['fullname'], $filter_search, $this->arrParam['key'], ['info', 'all'])],
