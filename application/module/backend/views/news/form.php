...
//===== ROW NAME ======
$inputTitle = Helper::input('text', 'form[title]', 'form[title]', $dataForm['title'], 'form-control form-control-sm');
$rowTitle   = Helper::row('Title', $inputTitle, true);
...
$inputLink = Helper::input('text', 'form[link]', 'form[link]', $dataForm['link'], 'form-control form-control-sm');
...
if (isset($this->arrParam['id'])) {
    $img = ' <img style=" width:200px; margin-left: 165px;" src="' . URL_PUBLIC . 'files/news/' . $nameImg . '" alt="your image" />';
    if (isset($gallery)) {
...
//===== STR ROW ======
$strRow = $rowTitle . $rowShortDescription . $rowDescription . $rowLink . $rowStatus . $rowPicture . $img  . $arrImg . $inputPictureHidden . $inputToken;
