...
class UserController extends Controller
{
	...
	public function indexAction()
	{
		...
		$this->_view->countActive    = $this->_model->countItems($this->_arrParam, ['task' => 'count_active']);
		$this->_view->countInactive  = $this->_model->countItems($this->_arrParam, ['task' => 'count_inactive']);
		$this->_view->slbFilterGroup = $this->_model->itemInSelectBox($this->_arrParam, ['task' => 'add_default']);
	...
	public function formAction()
	{
		...
		$this->_view->slbGroup = $this->_model->itemInSelectBox($this->_arrParam, ['task' => 'add_default']);
