...
{
    private $_columns = ['id', 'name',  'picture', 'video', 'created', 'created_by', 'modified', 'modified_by', 'status', 'ordering'];
    ...
    public function saveItem($params, $options = [])
    {
        ...
        if ($options['task'] == 'add') {
            ...
            $params['form']['picture']    = $uploadObj->uploadFile($params['form']['picture'], 'video');
