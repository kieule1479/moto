...
{
    private $_columns = ['id', 'name', 'picture', 'created', 'created_by', 'modified', 'modified_by', 'status', 'ordering', 'special'];
    ...
    public function listItems($arrParam, $options = null)
    {
        ...
        $query[] = "SELECT `id`, `name`, `picture`, `created`, `created_by`, `modified`, `modified_by`, `status`, `ordering`, `special`";
        $query[] = "FROM `$this->table`";
        $query[] = "WHERE `id` > 0";
    ...
    public function deleteItems($arrParam, $options = [])
    {
        ...
        foreach ($arrImg as $val) {
            $uploadObj->removeFile('category', $val);
            $uploadObj->removeFile('category', '220x147-' . $val);
        }
    ...
    public function saveItem($params, $options = [])
    {
        ...
        if ($options['task'] == 'edit') {
            ...
            if ($params['form']['picture'] == null) {
                ...
                $uploadObj->removeFile('category', $name);
                $uploadObj->removeFile('category', '220x147-' . $name);
            }
