<?php
	...
	$linkMotoManager	= URL::createLink('admin', 'moto', 'index');
	$linkAddMoto		= URL::createLink('admin', 'moto', 'form');
	...
	<div id="header-box">
        ...
        <div id="module-menu">
            ...
            <ul id="menu" >
				...
				<li class="node"><a href="#">Moto Shopping</a>
					<ul>
						<li class="node">
						...
						<li class="node">
							<a class="icon-16-article" href="<?php echo $linkMotoManager;?>">moto Manager</a>
							<ul id="menu-com-users-groups" class="menu-component">
								<li><a class="icon-16-newarticle" href="<?php echo $linkAddMoto;?>">Add New Moto</a></li>
							</ul>
						</li>
					</ul>
				</li>
